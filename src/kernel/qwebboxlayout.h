...
public:
    ...
    virtual void addItem(QWebLayoutItem* item, int size = 1);
    void addWebget(QWebWebget* w, int size = 1);
    void addLayout(QWebLayout* l, int size = 1);
    void addStretch(int size = 1);
    virtual void insertItem(int index, QWebLayoutItem* item, int size = 1);
    void insertWebget(int index, QWebWebget* w, int size = 1);
    void insertLayout(int index, QWebLayout* l, int size = 1);
